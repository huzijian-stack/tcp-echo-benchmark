...
### 性能优化
- **基础版本**：Epoll + TCP_NODELAY + 非阻塞 I/O
- **eBPF 版本**：Sockmap 内核加速，零拷贝转发

### 实测性能提升
基于实际 benchmark 测试（10 连接 × 100,000 轮 × 64 字节）：

| 指标 | 基础版本 | eBPF 版本 | 提升幅度 |
|------|----------|-----------|----------|
| **QPS** | 132,233.12 请求/秒 | 201,747.09 请求/秒 | **+52.57%** |
| **平均延迟** | 7.56 微秒 | 4.96 微秒 | **34.39%** |
| **CPU 使用率** | 55.63% | 45.54% | **18.14%** |
